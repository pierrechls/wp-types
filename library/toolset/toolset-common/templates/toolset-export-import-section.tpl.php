<div<?php if ( isset( $item_data['slug'] ) ) { echo ' id="toolset-' . $item_data['slug'] . '"'; } ?> class="toolset-setting-container js-toolset-setting-container<?php if ( isset( $item_data['slug'] ) ) { echo ' js-toolset-' . $item_data['slug']; } ?>">
